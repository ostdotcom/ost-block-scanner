...
class TransactionModel extends ShardedBase {
   ...
   *
   * @returns {{chainId: string, transactionHash: string, blockNumber: string, transactionIndex: string, fromAddress: string, toAddress: string, value: string, gasUsed: string, gasPrice: string, nonce: string, input: string, logs: string, r: string, s: string, v: string, blockTimestamp: string, transactionStatus: string, transactionInternalStatus: string, updatedTimestamp: string}}
   */
