...
class BlockModel extends ShardedBase {
   ...
   *
   * @returns {{chainId: string, blockNumber: string, blockHash: string, parentBlockHash: string, gasLimit: string, gasUsed: string, totalTransactions: string, blockTimestamp: string, difficulty: string, extraData: string, miner: string, nonce: string, stateRoot: string, receiptsRoot: string, transactionsRoot: string, size: string, sha3Uncles: string, isFinal: string, createdTimestamp: string, updatedTimestamp: string}}
   */
