...
class CreateEconomy {
  ...
  constructor(params, options) {
    ...
    if (options) {
      ...
      if (options.gatewayContractAddress) {
        oThis.gatewayContractAddress = options.gatewayContractAddress;
      }
  ...
  async updateIntoEconomy(contractDetails) {
    ...
    if (oThis.gatewayContractAddress) {
      insertParams['gatewayContractAddress'] = oThis.gatewayContractAddress.toLowerCase();
    }
